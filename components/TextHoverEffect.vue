<template>
  ...
  >
    ...
    <text
      ...
      class="fill-transparent stroke-neutral-200 font-[helvetica] text-lg font-bold dark:stroke-neutral-800"
    >
      {{ text }}
    </text>
    ...
    <text
      ...
      :stroke-width="strokeWidth"
      mask="url(#textMask)"
      class="fill-transparent font-[helvetica] text-lg font-bold"
    >
      {{ text }}
    </text>
  </svg>
